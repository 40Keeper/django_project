...
client.connect('10.114.10.87', port=22, username='pi', password='raspberry')   #change IP for what is reqd

#time.sleep(5)
#time module causing the ssh connection to remain open. root cause not known. can be used for exploitation when attacking
print('Connected to 10.114.10.87')
stdin, stdout, stderr = client.exec_command("python3 /home/pi/python/sensor_server.py")
